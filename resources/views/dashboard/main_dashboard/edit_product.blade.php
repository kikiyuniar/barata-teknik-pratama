                                ...
                                <div class="col-sm-12">
                                    ...
                                    {{-- @if (session('success'))
                                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                                            Something it's wrong:
                                            <ul>
                                                @foreach ($success->all() as $berhasil)
                                                    <li>{{ $berhasil }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    ...
                                    <form action="action_edit/{{$item->id}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 mt-3">
                                                ...
                                                <a data-toggle="modal" data-target="#modalForm1" class="btn btn-outline-info mb-5">Update Image 1</a>
                                            </div>
                                            <div class="col-md-4 mt-3">
                                                <div class="form-group">
                                                    <img src="{{ URL::asset('img_products') }}/{{$item->foto2}}" alt="">
                                                </div>
                                                <a data-toggle="modal" data-target="#modalForm2" class="btn btn-outline-info mb-5">Update Image 2</a>
                                            </div>
                                            <div class="col-md-4 mt-3">
                                                <div class="form-group">
                                                    <img src="{{ URL::asset('img_products') }}/{{$item->foto3}}" alt="">
                                                </div>
                                                <a data-toggle="modal" data-target="#modalForm3" class="btn btn-outline-info mb-5">Update Image 3</a>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-4">
