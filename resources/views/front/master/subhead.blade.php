            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a style="color: black;" class="nav-link" href="{{url('/#contactus')}}">Contact Us</a>
                        </li>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <div class="dropdown-menu  ">
                            ...
                            <a class="dropdown-item {{ Request::is('../../product/categories/'.$item->slug_kategori) ? 'active' : '' }}" href="{{ ('../../product/categories/'.$item->slug_kategori) }}">{{$item->name}}</a>
                            @endforeach
                        </div>
                        <br>
                        </li>
